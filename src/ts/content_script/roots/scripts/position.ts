...
export class Position {
    ...
    public position_title_el = (): void =>
        err(() => {
            // needed because in some cases icons go outside container. ex: https://www.google.com/search?q=infinite+scroll&oq=infinite&aqs=chrome.4.69i57j46j0j46j0j69i61j69i60l2.7170j0j1&sourceid=chrome&ie=UTF-8
    ...
    public remove_offset_classes = (): void =>
        err(() => {
            // needed because in some cases icons go outside container. ex: https://www.google.com/search?q=infinite+scroll&oq=infinite&aqs=chrome.4.69i57j46j0j46j0j69i61j69i60l2.7170j0j1&sourceid=chrome&ie=UTF-8
            x.remove_cls(s_el_parser.Main.i().title_els, s_roots.Position.i().offset_1_cls);
            x.remove_cls(s_el_parser.Main.i().title_els, s_roots.Position.i().offset_2_cls);
        }, 'ges_1086');
}
